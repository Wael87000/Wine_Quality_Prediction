# -*- coding: utf-8 -*-
"""
Created on Wed Jan  6 22:23:37 2021
...
train = pd.read_csv('Entrainement.csv',delimiter=';') #delimiter=';' muy importante!!! 
...
#np.savetxt('Data_description.txt',train.describe(),fmt="%s")
